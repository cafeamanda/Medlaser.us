...
angular.module('medlaserApp')
  ...
  .factory('regulationFactory', function() {

    var regfac = {};

    var regulations=[
      {
        path: 'files/K133006.pdf',
        title: 'Regulation',
        authors: 'Department of Health & Human Services',
        date: 'April 17, 2014'
      },
      {
        path:'files/K152722.pdf',
        title:'Regulation',
        authors:'Department of Health & Human Services',
        date:'December 8, 2015'
      },
      {
        path:'files/neoLaser-ISO13485-Certificate-2013-English.pdf',
    ...
    regfac.getFiles = function() {
      return regulations;
    };
    regfac.getFile = function() {
